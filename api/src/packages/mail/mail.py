...
<body>
    ...
    <main>
        <div class="container">
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, voluptate! Saepe nostrum repellat accusamus corporis, recusandae dolor ipsa eaque odio sed dignissimos illo? Voluptates sint vitae, reprehenderit veniam quibusdam magni.
            </p>
        </div>
    </main>
    <footer>
...
def tag_to_dict(tag):
    ...
    if len(children) == 1:
        ...
        return {tag.name: {'attrs': tag.attrs, 'children': children}}
    else:
        return {tag.name: {'attrs': tag.attrs, 'content': tag.string}}

# create a soup object
soup = BeautifulSoup(html, "html.parser")

# Convert the soup object to a dictionary
soup_dict = tag_to_dict(soup)
